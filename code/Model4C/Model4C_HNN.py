...
fine_classification_report = (classification_report(fine_final_test.fine_label, fine_final_test.fine_label_prediction))
print(fine_classification_report)
# Print to the text file
file = open('fine_classification.txt', 'w')
print("Total Training Time All levels=",total_train_time, file = file)
print("Fine Level Accuracy = ", accuracy_score(fine_final_test.fine_label, fine_final_test.fine_label_prediction), file = file)
...
medium_classification_report = (classification_report(fine_final_test.medium_label, fine_final_test.medium_label_prediction))
print(fine_classification_report)
# Print to the text file
file = open('medium_classification.txt', 'w')
print("Total Training Time All levels=",total_train_time, file = file)
print("Medium Level Accuracy = ", accuracy_score(fine_final_test.medium_label, fine_final_test.medium_label_prediction), file = file)
...
coarse_classification_report = (classification_report(fine_final_test.coarse_label, fine_final_test.coarse_label_prediction))
print(coarse_classification_report)
# Print to the text file
file = open('coarse_classification.txt', 'w')
print("Total Training Time All levels=",total_train_time, file = file)
print("Coarse Level Accuracy = ", accuracy_score(fine_final_test.coarse_label, fine_final_test.coarse_label_prediction), file = file)
